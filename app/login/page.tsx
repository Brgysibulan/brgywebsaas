  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-100 px-6">
      <form onSubmit={submit} className="w-full max-w-md rounded-2xl border bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 inline-flex rounded-full bg-sky-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-sky-700">SUPER ADMIN LOGIN</p>
        <h1 className="mt-3 text-3xl font-bold">Super Admin Sign in</h1>
        <p className="mt-2 text-sm text-slate-500">Authorized Super Admin accounts only.</p>
        ...
        <button disabled={loading} className="mt-6 w-full rounded-lg bg-sky-600 px-4 py-3 font-semibold text-white disabled:opacity-50">{loading ? "Signing in..." : "Sign in as Super Admin"}</button>
